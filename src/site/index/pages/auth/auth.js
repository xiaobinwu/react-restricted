                    ...
                    <Form onSubmit={this.handleSubmit}>
                        ...
                        <FormItem>
                            { getFieldDecorator('password', {
                                ...
                                <Input styleName='login-input' prefix={<Icon type="lock" styleName="login-icon" />} size="large" type="password" placeholder="Password" />
                            )}
                        </FormItem>
                        <FormItem>
                            ...
                            <Button type="primary" htmlType="submit" styleName="login-form-button" size="large">
                                Log in
                            </Button>
                        </FormItem>
                    </Form>
...
const WrappedAuthForm = Form.create()(CSSModules(Auth, styles));
